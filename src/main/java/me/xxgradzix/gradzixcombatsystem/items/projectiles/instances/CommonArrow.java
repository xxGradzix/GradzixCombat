...
public class CommonArrow implements CustomArrow {
    @Override
    ...
    public static final String CUSTOM_ID = "gradzixcombat_common_arrow";
    ...
    public String getName(int tier) {
        return ColorFixer.addColors("&7ᴢᴡʏᴋᴌᴀ ꜱᴛʀᴢᴀᴌᴀ " + getRomanNumerals(tier));
    }
