...
public class FreezeSuperChargeOrb implements CustomBattlePotionOrb {

    public static final String CUSTOM_ID = "gradzixcombat_fallen_hero_potion_orb_super_charge_freeze";
    ...
    public String getName(int tier) {
        return "ᴋʀʏꜱᴢᴛᴀł ʟᴏᴅᴏᴡᴇᴊ ᴇꜱᴇɴᴄᴊɪ";
    }
    ...
    public void onDrink(Player player) {
        MagicEffectManager.superChargePlayer(player, 3*60, Set.of(MagicEffectManager.MagicEffectType.FREEZE));
    }
